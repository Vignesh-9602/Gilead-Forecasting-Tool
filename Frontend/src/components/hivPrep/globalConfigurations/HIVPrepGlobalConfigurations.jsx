...
import { getHIVPrepConfigurationByTherapyArea, saveHIVPrepConfigurations } from "../../../services/apiService";
...
export default function HIVPrepGlobalConfigurations() {
    ...
    const fetchConfigurationByTA = async () => {
        try {
            ...
            const response = await getHIVPrepConfigurationByTherapyArea(therapyArea);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await saveHIVPrepConfigurations(payload);
